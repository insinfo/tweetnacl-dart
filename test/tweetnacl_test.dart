...
final String BOB_PRIVATE_KEY = "5dab087e624a8a4b79e17f8b83800ee66f3bb1292618b6fd1c2f8b27ff88e0eb";
final String BOB_PUBLIC_KEY = "de9edb7d7b7dc1b4d35b61c2ece435373f8343c85b78674dadfc7e146f882b4f";

final String ALICE_PRIVATE_KEY = "77076d0a7318a57d3c16c17251b26645df4c2f87ebc0992ab177fba51db92c2a";
final String ALICE_PUBLIC_KEY = "8520f0098930a754748b7ddcb43ef75a0dbf3a0d26381af4eba4a98eaa9b4e6a";
final String ALICE_MULT_BOB = "4a5d9d5ba4ce2de1728e3bf480350f25e07e21c947d19e3376f09b3c1e161742";

final String BOX_NONCE = "69696ee955b62b73cd62bda875fc73d68219e0036b7a0b37";
final String BOX_MESSAGE = "be075fc53c81f2d5cf141316ebeb0c7b5228c52a4c62cbd44b66849b64244ffc" +
    "e5ecbaaf33bd751a1ac728d45e6c61296cdc3c01233561f41db66cce314adb31" +
    "0e3be8250c46f06dceea3a7fa1348057e2f6556ad6b1318a024a838f21af1fde" +
    "048977eb48f59ffd4924ca1c60902e52f0a089bc76897040e082f93776384864" +
    "5e0705";
final String BOX_CIPHERTEXT = "f3ffc7703f9400e52a7dfb4b3d3305d98e993b9f48681273c29650ba32fc76ce" +
...
final String SECRET_KEY = "1b27556473e985d462cd51197a9a46c76009549eac6474f206c4ee0844f68389";
...
// keypair A
  ...
  String skat = "";
  for (int i = 0; i < ka.secretKey!.length; i++) skat += " ${ka.secretKey![i]}";
  print("skat: " + skat);

  String pkat = "";
  for (int i = 0; i < ka.publicKey!.length; i++) pkat += " ${ka.publicKey![i]}";
  print("pkat: " + pkat);
...
// keypair B
  ...
  String skbt = "";
  for (int i = 0; i < kb.secretKey!.length; i++) skbt += " ${kb.secretKey![i]}";
  print("skbt: " + skbt);

  String pkbt = "";
  for (int i = 0; i < kb.publicKey!.length; i++) pkbt += " ${kb.publicKey![i]}";
  print("pkbt: " + pkbt);
...
// cipher A -> B
  ...
  String cabt = "";
  for (int i = 0; i < cab.length; i++) cabt += " ${cab[i]}";
  print("cabt: " + cabt);

  Uint8List mba = pba.open(Uint8List.fromList(cab))!;
  String mbat = "";
  for (int i = 0; i < mba.length; i++) mbat += " ${mba[i]}";
  print("mbat: " + mbat);
...
// cipher B -> A
  ...
  for (int i = 0; i < b0.length; i++) b0[i] = i;
...
//  print("BoxNonce Hex test Equal: " + "\"" + (theNonce == theNonce3) + "\"");
  String theNoncet = "";
  for (int i = 0; i < theNonce.length; i++) theNoncet += " ${theNonce[i]}";
...
void testSecretBox() {
  ...
  for (int i = 0; i < shk.length; i++) shk[i] = 0x66;
...
void testSign() {
  ...
  String sgt = "sign@" + m0 + ": ";
  for (int i = 0; i < Signature.signatureLength; i++) sgt += " ${sab![i]}";
  print(sgt);
  ...
  String skct = "";
  for (int i = 0; i < kc.secretKey!.length; i++) skct += " ${kc.secretKey![i]}";
  print("skct: " + skct);

  String pkct = "";
  for (int i = 0; i < kc.publicKey!.length; i++) pkct += " ${kc.publicKey![i]}";
  print("pkct: " + pkct);
  ...
  for (int i = 0; i < Signature.signatureLength; i++) ssc += " ${scc![i]}";
  print(ssc);
